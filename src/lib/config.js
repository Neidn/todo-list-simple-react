...
const API_GET_DONE_TODOS_URL = `${API_GET_TODOS_URL}/done`;
const API_GET_UNDONE_TODOS_URL = `${API_GET_TODOS_URL}/undone`;
const API_GET_TODO_ID_URL = `${API_GET_TODOS_URL}/:id`;
